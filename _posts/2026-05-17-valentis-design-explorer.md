...
<figure>
  ...
  <figcaption>Valentis Design Explorer 결과 화면 — 좌측에 제약조건·목적함수 정의 패널,<br>우측에 Top 3 카드와 실현 가능 케이스 테이블이 한 화면에 정리된다.</figcaption>
</figure>
...
| Rank | Case | Score | Fan<br>위치 | PCB<br>간격 | 핀 높이 | 내부<br>평균 | 메인 칩 | 작은 칩 | 작은 PCB | 메인 PCB |
|---|---|---|---|---|---|---|---|---|---|---|
...
<figure>
  ...
  <figcaption>평행좌표 차트 — 입력 변수 3개와 출력 변수 8개가 11개의 수직 축으로 나란히 배치되고,<br>각 케이스는 Rank 컬러바(파랑→빨강)를 따라 색이 입혀진 꺾은선으로 표현된다.</figcaption>
</figure>
